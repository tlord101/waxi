...
export interface PageDesignSpec {
  // Design spec contains design-only values the AI will return. The app enforces CSS/classes.
  ...
  buttons?: Array<{
    text: string;
    link?: string;
    style?: string; // optional hint like 'primary', 'ghost'
  }>;
  layout?: string; // e.g., 'centered', 'split', 'hero-left'
  classes?: string; // optional additional class string for fine-tuning
...
export interface SiteContent {
  ...
  // Admin-editable menu and arbitrary page specs generated by AI
  menu?: MenuItem[];
  pages?: Record<string, PageDesignSpec>;
}