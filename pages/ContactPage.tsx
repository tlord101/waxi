            ...
            <div className="space-y-6">
                ...
                <div className="space-y-4 text-lg text-gray-700 dark:text-gray-300">
                    <div className="flex items-start space-x-4">
                        <ion-icon name="location-outline" class="text-byd-red text-2xl mt-1"></ion-icon>
                        <span>No. 888, BYD Avenue, Xishan District, Wuxi, Jiangsu, China</span>
                    </div>
                     <div className="flex items-center space-x-4">
                        <ion-icon name="call-outline" class="text-byd-red text-2xl"></ion-icon>
                        <span>+86-510-1234-5678</span>
                    </div>
                     <div className="flex items-center space-x-4">
                        <ion-icon name="mail-outline" class="text-byd-red text-2xl"></ion-icon>
